...
def test_clamav_provider_initialization_override():
    # Mock provider_cfg to return enabled: False in YAML
    with patch("waechter.providers.clamav.provider_cfg") as mock_cfg:
...
def test_clamav_provider_initialization_yaml_fallback():
    # Mock provider_cfg to return enabled: True in YAML
    with patch("waechter.providers.clamav.provider_cfg") as mock_cfg:
